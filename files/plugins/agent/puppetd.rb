module MCollective
    module Agent
        ...
        class Puppetd<RPC::Agent
            ...
            def runonce
                cmd = [@puppetd, "--onetime", "--pidfile=/var/run/puppet/mco.pid"]
                ...
                Log.instance.debug("Running puppet command: #{cmd}")
            ...
            def noop
                cmd = [@puppetd, "--onetime", "--pidfile=/var/run/puppet/mco.pid", "--noop"]
